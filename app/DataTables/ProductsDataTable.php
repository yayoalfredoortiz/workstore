...
class ProductsDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->rawColumns(['action', 'price', 'allow_purchase', 'check', 'name', 'image']);
    }
    ...
    public function query(Product $model)
    {
        ...
        $model = $model->with('tax', 'category', 'subCategory')->select('id', 'name', 'price', 'taxes', 'allow_purchase', 'added_by', 'image', 'category_id', 'sub_category_id', 'description');
    ...
    protected function getColumns()
    {
        return [
            ...
            __('modules.productImage') => ['data' => 'image', 'name' => 'image', 'title' => __('modules.productImage'), 'exportable' => false,],
