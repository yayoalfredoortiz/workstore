...
class EmployeeTimelogs extends AccountBaseController implements FromView, ShouldAutoSize, WithStyles
{
    ...
    {
        $this->startDate = $startDate = Carbon::createFromFormat($this->global->date_format, urldecode(request()->startDate))->toDateString();
        $this->endDate = $endDate = Carbon::createFromFormat($this->global->date_format, urldecode(request()->endDate))->toDateString();
