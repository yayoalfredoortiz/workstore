            ...
            <x-slot name="action">
                ...
                <div class="w-100 border-top-grey">
                    <x-setting-form-actions>
                        ...
                        {{-- @if ($setting->google_calendar_verification_status == 'non_verified' && empty($setting->token) && empty($setting->name) && empty($setting->google_id))
                            <a href="{{ route('googleAuth') }}" class="text-lightest f-12"><u>@lang('app.verify')<i class="fa fa-external-link-alt"></i></u></a>
                        @endif

                        @if ($setting->google_calendar_verification_status == 'verified' && !empty($setting->token) && !empty($setting->name) && !empty($setting->google_id))
                            <a href="javascript:;" class="text-lightest f-12" id=""><u>@lang('app.disable')<i class="fa fa-external-link-alt"></i></u></a>
                        @endif --}}
