            ...
            <div class="add-client bg-white rounded">
                ...
                <div class="row px-4 @if ($note->type == 0) d-none @endif" id="private-note-details">
                    ...
                    <div class="col-md-3">
                        ...
                        <x-forms.checkbox :fieldLabel="__('modules.lead.visibleToLead')" fieldName="is_lead_show"
                            fieldId="is_lead_show" fieldValue="1" fieldRequired="true"
                            :checked="$note->is_lead_show == 1" />
                    </div>
