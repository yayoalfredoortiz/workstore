                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-xl-12">
                                <x-forms.file allowedFileExtensions="png jpg jpeg" class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.productImage')"
                                    fieldName="image" fieldId="image" fieldHeight="119" :popover="__('messages.fileFormat.ImageFile')" />
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        quillImageLoad('#product-description');
        ...
        $('#save-product-form').click(function() {
            ...
            var note = document.getElementById('product-description').children[0].innerHTML;
