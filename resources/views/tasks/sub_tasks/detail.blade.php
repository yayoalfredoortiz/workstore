...
<div class="modal-body">
    <div id="leave-detail-section">
        <div class="row">
            <div class="col-sm-12">
                <x-cards.data-row :label="__('app.title')" :value="ucfirst($subTask->title)" html="true" />
                <x-cards.data-row :label="__('app.description')" :value="$subTask->description" html="true" />
                <x-cards.data-row :label="__('modules.invoices.due')" :value="((!is_null($subTask->due_date)) ? $subTask->due_date->format($global->date_format) : '--')" html="true" />
